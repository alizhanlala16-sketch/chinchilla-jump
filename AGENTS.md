...
| **Яблоко** 🍎 | +1 жизнь | — | 2.5% |
| **Ракета** | летит вверх со скоростью `-8.5`, рушит врагов | 360 кадров (~6 сек) | 1.2% |
| **Щит** | поглощает удары, отбивает пилы, спасает от падения (телепорт на 3-ю платформу выше) | 1140 кадров (~19 сек) | 1.2% |
| **Лазеры из ушей** | два луча из ушей, уничтожают пилы, ножи, лис, белок | 900 кадров (~15 сек) | 1.0% |
